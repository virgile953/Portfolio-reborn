...
export const portfolioProjects = [
	...
	},
	{
		...
		description: `This project was a complete redesign of the legacy SaaS application used by fleet managers to streamline operations and data management. Aiming to enhance both user experience and performance, this project introduced a more intuitive interface, improved data visualization, and integrated advanced analytics features.
	...
	},
	{
		...
		description: `Created a tool for bulk email sending, with automatic HTML processing for personalized email to the recipient.
